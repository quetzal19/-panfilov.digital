...
const __vue_inject_styles__ = function (inject) {
  ...
  inject("data-v-6f4d5224_0", {
    source: ".panfilov-digital-sign[data-v-6f4d5224]{color:var(--panfilov-digital-sign__currentTextColor);text-decoration:none;display:flex;flex-wrap:wrap}.panfilov-digital-sign._small[data-v-6f4d5224]{flex-direction:column-reverse;align-items:flex-start}.panfilov-digital-sign._small>.text[data-v-6f4d5224]{margin-top:5px}.panfilov-digital-sign._medium[data-v-6f4d5224]{align-items:center}.panfilov-digital-sign._large[data-v-6f4d5224]{align-items:center}.panfilov-digital-sign._large .wrapper[data-v-6f4d5224]{margin-left:8px;display:flex;flex-direction:column-reverse;align-items:flex-start}.panfilov-digital-sign._large .text[data-v-6f4d5224]{margin-top:5px;transition:.2s}.panfilov-digital-sign .icon[data-v-6f4d5224]{display:flex}.panfilov-digital-sign .icon svg[data-v-6f4d5224]{color:var(--panfilov-digital-sign__currentSVGColor);width:6em;height:1.5em;transition:.2s}.panfilov-digital-sign .icon svg[data-v-6f4d5224]:last-child{width:5em}.panfilov-digital-sign[data-v-6f4d5224]:hover{color:var(--panfilov-digital-sign__hoverTextColor)}.panfilov-digital-sign:hover .icon svg[data-v-6f4d5224]{color:var(--panfilov-digital-sign__hoverTextColor)}.panfilov-digital-sign:hover .icon svg[data-v-6f4d5224]:last-child{color:var(--panfilov-digital-sign__hoverSVGColor)}",
    map: undefined,
    media: undefined
  });
};
