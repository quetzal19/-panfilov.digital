(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["panfilov.digital"] = factory();
	else
		root["panfilov.digital"] = factory();
...
__webpack_require__.d(__webpack_exports__, {
  "PanfilovDigitalSign": () => (/* reexport */ sign)
});
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/vue/sign/index.vue?vue&type=template&id=43352148&scoped=true


const _withScopeId = n => (pushScopeId("data-v-43352148"),n=n(),popScopeId(),n)
const _hoisted_1 = ["href"]
const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createBaseVNode("span", { class: "text" }, "Разработка сайта", -1))
const _hoisted_3 = { class: "icon" }
const _hoisted_4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createBaseVNode("span", { class: "text" }, "Разработка сайта — ", -1))
const _hoisted_5 = { class: "icon" }
const _hoisted_6 = { class: "wrapper" }
const _hoisted_7 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createBaseVNode("span", { class: "text" }, "Разработка сайта", -1))
const _hoisted_8 = { class: "icon" }

function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_panfilovSVG = resolveComponent("panfilovSVG")
  const _component_digitalSVG = resolveComponent("digitalSVG")
  const _component_logoWhiteSVG = resolveComponent("logoWhiteSVG")
  const _component_logoBlackSVG = resolveComponent("logoBlackSVG")

  return (openBlock(), createElementBlock("a", {
    href: $props.url,
    class: normalizeClass(["panfilov-digital-sign", [`_${$props.mode}`]])
  }, [
    ($props.mode === 'small')
      ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          _hoisted_2,
          createBaseVNode("span", _hoisted_3, [
            createVNode(_component_panfilovSVG),
            createVNode(_component_digitalSVG)
          ])
        ], 64))
    ...
    ($props.mode === 'large')
      ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
          (!$props.darkTheme)
            ? (openBlock(), createBlock(_component_logoWhiteSVG, { key: 0 }))
            : createCommentVNode("", true),
          ($props.darkTheme)
            ? (openBlock(), createBlock(_component_logoBlackSVG, { key: 1 }))
            : createCommentVNode("", true),
...
;// CONCATENATED MODULE: ./src/vue/sign/index.vue?vue&type=template&id=43352148&scoped=true

;// CONCATENATED MODULE: ./src/assets/ico/logo/digital.svg?inline
const digitalinline_namespaceObject = __webpack_require__.p + "img/digital.c5d6c030.svg";
;// CONCATENATED MODULE: ./src/assets/ico/logo/panfilov.svg?inline
const panfilovinline_namespaceObject = __webpack_require__.p + "img/panfilov.5700e5e6.svg";
;// CONCATENATED MODULE: ./src/assets/ico/logo/logo-white.svg?inline
const logo_whiteinline_namespaceObject = __webpack_require__.p + "img/logo-white.f09b7301.svg";
;// CONCATENATED MODULE: ./src/assets/ico/logo/logo-black.svg?inline
const logo_blackinline_namespaceObject = __webpack_require__.p + "img/logo-black.d1706d0f.svg";
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/vue/sign/index.vue?vue&type=script&lang=js
...
/* harmony default export */ const signvue_type_script_lang_js = ({

  name: 'PanfilovDigitalSign',

  components: {
    logoWhiteSVG: logo_whiteinline_namespaceObject,
    logoBlackSVG: logo_blackinline_namespaceObject,
    digitalSVG: digitalinline_namespaceObject,
    panfilovSVG: panfilovinline_namespaceObject,
  },
...
;// CONCATENATED MODULE: ./src/vue/sign/index.vue?vue&type=script&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(744);
;// CONCATENATED MODULE: ./src/vue/sign/index.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(signvue_type_script_lang_js, [['render',render],['__scopeId',"data-v-43352148"]])

/* harmony default export */ const sign = (__exports__);
...
//# sourceMappingURL=panfilov.digital.umd.js.map